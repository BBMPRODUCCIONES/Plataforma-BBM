              ...
              >
                ...
                <DialogPrimitive.Content
                  ...
                  className={cn(
                    ...
                    "flex flex-col",
                    isLandscape 
                      ? "w-[min(95vw,700px)] max-h-[calc(100dvh-env(safe-area-inset-top,0px)-env(safe-area-inset-bottom,0px)-24px)]"
                ...
                >
                  ...
                  <div className="flex-1 overflow-auto">
                    {isLandscape ? (
                      /* Layout Landscape: Presets izquierda + 2 calendarios */
                      <div className="flex h-full">
                        <div className="border-r border-border p-2 space-y-1 flex-shrink-0">
                          <Button 
                            size="sm" 
                            variant="ghost" 
                            className="w-full justify-start h-9 px-2 text-xs whitespace-nowrap touch-manipulation"
                        ...
                        <div className="p-2 overflow-auto flex-1 flex justify-center">
                          <Calendar
                            mode="range"
                            selected={tempRange}
                            ...
                            classNames={{
                              ...
                              nav_button: "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 inline-flex items-center justify-center rounded-md border border-input touch-manipulation",
                              ...
                              day: "h-8 w-8 p-0 font-normal text-xs aria-selected:opacity-100 inline-flex items-center justify-center rounded-md touch-manipulation",
